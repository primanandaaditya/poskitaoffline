...
public class SinkronDeleteUnitController implements ISinkronDeleteUnitRequest {

    Context context;
    SweetAlertDialog sweetAlertDialog;
    ISinkronDeleteUnitResult iSinkronDeleteUnitResult;
    ISinkronDeleteUnit iSinkronDeleteUnit;
    ...
    public SinkronDeleteUnitController(Context context, ISinkronDeleteUnitResult iSinkronDeleteUnitResult) {
        ...
        this.iSinkronDeleteUnitResult = iSinkronDeleteUnitResult;
...
//                sweetAlertDialog.show();
                ...
                iSinkronDeleteUnit.delete_unit(data, auth_token).enqueue(new Callback<SinkronResponse>() {
                    ...
                    public void onResponse(Call<SinkronResponse> call, Response<SinkronResponse> response) {
                        ...
                        iSinkronDeleteUnitResult.onSinkronDeleteUnitSuccess(response.body());
//                        ubahStatusSudahSync();
//                        sweetAlertDialog.dismissWithAnimation();
                    ...
                    public void onFailure(Call<SinkronResponse> call, Throwable t) {
                        ...
                        iSinkronDeleteUnitResult.onSinkronDeleteUnitError(t.getMessage().toString());
//                        sweetAlertDialog.dismissWithAnimation();
            ...
            iSinkronDeleteUnitResult.onSinkronDeleteUnitError(context.getResources().getString(R.string.tidak_ada_koneksi_internet));
        }
    }
    ...
    public String kumpulkan_data() {
        ...
        for (Unit unit : units){
            ...
            if (unit.getSync_delete() == Constants.STATUS_BELUM_SYNC){
