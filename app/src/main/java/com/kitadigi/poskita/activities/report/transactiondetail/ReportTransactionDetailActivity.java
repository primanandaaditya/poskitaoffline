...
public class ReportTransactionDetailActivity extends BaseActivity implements MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager=new SessionManager(ReportTransactionDetailActivity.this);
...
//        this.applyFontRegularToTextView(tv_tanggal);
    ...
    public void requestReport(String enkripIdUser, String enkripTransaksi) {
        ...
        presenter=new ReportTransactionDetailPresenter(this, new ReportTransactionDetailImpl(enkripIdUser,enkripTransaksi, ReportTransactionDetailActivity.this));
        presenter.requestDataFromServer();
    }

    @Override
    public void setDataToView(TransactionDetailModel transactionDetailModel) {
//        this.showToast(transactionDetailModel.getMessage());
        ReportTransactionDetailAdapter reportTransactionDetailAdapter=new ReportTransactionDetailAdapter(this,transactionDetailModel,ReportTransactionDetailActivity.this);
        lv.setAdapter(reportTransactionDetailAdapter);
