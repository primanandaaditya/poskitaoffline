...
public class ReportStokDetailActivity extends BaseActivity implements IReportStokDetailActivityContract.IReportStokDetailMainView {


    IReportStokDetailActivityContract.IReportStokDetailPresenter presenter;
    ...
    //untuk nangkap 'additional' dari intent ReportStokActivity.java
    String additional;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_stok_detail);
        ...
        //simpan nilai additional di variabel additional
        ...
        sessionManager=new SessionManager(ReportStokDetailActivity.this);
...
//        this.applyFontRegularToTextView(tv_tanggal);
    ...
    @Override
    public void requestReport(String enkripIdUser, String enkripIdTransaksi, String start_date, String end_date) {
        ...
        presenter=new ReportStokDetailPresenter(this, new ReportStokDetailActivityImpl(enkripIdUser,enkripIdTransaksi,hashMapStartDate,hashMapEndDate,ReportStokDetailActivity.this));
        presenter.requestDataFromServer();
    }

    @Override
    public void setDataToView(ReportDetailModel reportDetailModel) {

        if (this.sessionExpired(reportDetailModel.getMessage())==0){
            if (reportDetailModel.getMessage().matches(getResources().getString(R.string.success))) {


                ReportStokDetailAdapter reportStokDetailAdapter=new ReportStokDetailAdapter(reportDetailModel,ReportStokDetailActivity.this);
                lv.setAdapter(reportStokDetailAdapter);

                //tampilkan info akumulasi stok & total
                tv_total_qty.setText(getResources().getString(R.string.label_accumulated_stock) + reportDetailModel.getAccumulated_stock() );
                tv_grand_total.setText(getResources().getString(R.string.label_total_current_stock) + reportDetailModel.getTotal_current_stock().toString());
    ...
    private void DialogFormStartDate() {
        ...
        dialog = new AlertDialog.Builder(ReportStokDetailActivity.this);
    ...
    private void DialogFormEndDate() {
        ...
        dialog.setPositiveButton(getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //tembak API
                requestReport(enkripIdUser,additional, tanggal_dari,tanggal_sampai);
