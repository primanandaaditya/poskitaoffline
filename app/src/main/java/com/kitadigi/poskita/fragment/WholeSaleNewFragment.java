 ...
 * {@link WholeSaleNewFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WholeSaleNewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WholeSaleNewFragment extends Fragment {
    private static final String TAG = WholeSaleNewFragment.class.getSimpleName();
    ...
    public static WholeSaleNewFragment newInstance(String param1, String param2) {
        WholeSaleNewFragment fragment = new WholeSaleNewFragment();
    ...
    private void initMain(View view) {
        ...
        tv_header.setTypeface(fontsBold);
        ...
        jsonListItems                               = db.getAllTransactionsTipeByDate("wholesale");
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                try {
                    ...
                    String jsonListItems = db.getListTransactionsByDate("wholesale", obj.getString("date"));
    ...
    public void filter(final Context context, final String nowday, final String nextmonthday){
        ...
        btnFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                jsonFilter         = db.getAllTransactionsFilterByDate(periodeAwal, periodeAkhir);
                setData(jsonFilter);
