...
public class StokDatum {
    ...
    public static Comparator<StokDatum> datumComparator = new Comparator<StokDatum>() {



        public int compare(StokDatum s1, StokDatum s2) {
            String dt1 = s1.getName_product().toUpperCase();
            String dt2 = s2.getName_product().toUpperCase();
