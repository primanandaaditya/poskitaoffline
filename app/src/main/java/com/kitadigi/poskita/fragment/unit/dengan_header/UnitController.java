...
import com.kitadigi.poskita.fragment.unit.IUnitRequest;
...
import com.kitadigi.poskita.fragment.unit.dengan_header.UnitUtil;
...
//            }
                ...
                iUnit.getUnitList(auth_token).enqueue(new Callback<UnitModel>() {
                    @Override
