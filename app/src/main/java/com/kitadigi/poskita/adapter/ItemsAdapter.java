...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.DataViewHolder> implements Filterable {
    ...
    public ItemsAdapter(Context context, List<Items> dataList, POSFragment posFragment) {
    ...
    @Override
    public ItemsAdapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
