...
public class ItemsSelectWholeSaleAdapter extends RecyclerView.Adapter<ItemsSelectWholeSaleAdapter.DataViewHolder> implements Filterable {
    ...
    public ItemsSelectWholeSaleAdapter(Context context, List<Items> dataList, WholeSaleFragment posFragment) {
    ...
    @Override
    public ItemsSelectWholeSaleAdapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(DataViewHolder holder, int position) {
        ...
        holder.rl_items.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                check = db.getCountListItemsTemp(items.getItemsName(), "2");
                Log.d("items", "items rv " + check);
                if(check == 0){
