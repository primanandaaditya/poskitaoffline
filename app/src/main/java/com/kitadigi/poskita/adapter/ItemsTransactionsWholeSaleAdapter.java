...
public class ItemsTransactionsWholeSaleAdapter extends RecyclerView.Adapter<ItemsTransactionsWholeSaleAdapter.DataViewHolder> {
    private List<TransactionsDetail> dataList;
    private Context mContext;
    private ItemsTransactionsWholeSaleActivity itemsTransactionsActivity;

    public ItemsTransactionsWholeSaleAdapter(Context context, List<TransactionsDetail> dataList, ItemsTransactionsWholeSaleActivity itemsTransactionsActivity) {
    ...
    @Override
    public ItemsTransactionsWholeSaleAdapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_transactions_data, parent, false);
        return new ItemsTransactionsWholeSaleAdapter.DataViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ItemsTransactionsWholeSaleAdapter.DataViewHolder holder, int position) {
