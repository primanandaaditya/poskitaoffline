...
import com.kitadigi.poskita.fragment.WholeSaleFragment;
...
public class ItemsWholeSaleAdapter extends RecyclerView.Adapter<ItemsWholeSaleAdapter.DataViewHolder> implements Filterable {
    private List<Items> dataList;
    private List<Items> dataListFiltered;
    private List<Items> dataAll;
    private Context mContext;
    private WholeSaleFragment posFragment;

    public ItemsWholeSaleAdapter(Context context, List<Items> dataList, List<Items> dataAll, WholeSaleFragment posFragment) {
    ...
    @Override
    public ItemsWholeSaleAdapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//            holder.iv_icon.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ic_plus));
            ...
            String price            = formatter.format(Integer.parseInt(items.getItemsPriceSell()));
                ...
                public void onClick(View v) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            posFragment.addItems(items.getIdItems(), items.getItemsName(), items.getItemsPriceSell(), items.getItemsImage(), items.getShortcut());
                        }
                    }, 1000);
                }
            });
