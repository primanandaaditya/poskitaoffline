...
public class SuccessTickLargeView extends View {
    private float mDensity = -1;
    private Paint mPaint;
    private final float CONST_RADIUS = dip2px(1.2f);
    private final float CONST_RECT_WEIGHT = dip2px(4);
    private final float CONST_LEFT_RECT_W = dip2px(25);
    private final float CONST_RIGHT_RECT_W = dip2px(55);
    ...
    public SuccessTickLargeView(Context context) {
        super(context);
        init();
    }

    public SuccessTickLargeView(Context context, AttributeSet attrs){
        super(context,attrs);
        init();
    }
